...
angular.module('BestBottle', ['ngCookies', 'ngResource', 'ngRoute', 'mgcrea.ngStrap', 'xeditable', 'Ymagik', 'SimpleRating']);

//Setting up route
angular.module('BestBottle').config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/', { controller : 'IndexController', templateUrl : 'views/main.html', jumbo : true })
