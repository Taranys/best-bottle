...
var bestbottleApp = angular.module('bestbottleApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'bestbottleAppUtils', 'pascalprecht.translate', 'truncate']);
