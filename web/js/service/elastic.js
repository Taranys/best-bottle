...
services.factory('api', function ($http) {
    ...
    api.delete = function (tableName, id) {
        return $http.delete(this.elasticSearchPath + tableName + '/' + id, {
            headers: {
